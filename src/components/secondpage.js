        ...
        <Container className='description-container'>
            <Row>
                ...
                <Col className='d-flex justify-content-center bilbo-col' xs= {{span:10, offset:1}} md={{span:4, offset:1}}>
                    <img id='blob-milieu-top' src={require('../style/Blob-Milieu-Top.svg')} alt='blob'></img>
                    <img id='blob-milieu-bottom' src={require('../style/Blob-Milieu-Bottom.svg')} alt='blob'></img>
                    <Image id='bilbo-gif' src={require('../style/bilbo.gif')} rounded />
                </Col>
            </Row>
