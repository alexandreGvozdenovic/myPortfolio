        ...
        <Container className='description-container' id='about'>
            <Row>
                ...
                <Col className='d-flex justify-content-center bilbo-col' xs= {{span:10, offset:1}} md={{span:4, offset:1}}>
                    <img id='blob-milieu-top' src={require('../blobs/Blob-Milieu-Top.svg')} alt='blob'></img>
                    <img id='blob-milieu-bottom' src={require('../blobs/Blob-Milieu-Bottom.svg')} alt='blob'></img>
                    <Image id='bilbo-gif' src={require('../PossibleShowyHake-size_restricted.gif')} rounded />
                </Col>
            </Row>
